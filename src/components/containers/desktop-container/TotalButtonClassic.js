...
const TotalButtonClassic = (props) => {
  ...
  return (
    ...
    >
      {props.button.status === 1 && dealing === "classic" && 
        <div className="match-money-label">
          {props.button.name} {props.button.line !== null ? props.button.line : ''}
        </div>
      }
...
export default TotalButtonClassic;
