...
import { clearAllBets, setBetQuotes, toggleErrorToast, toggleErrorToastText, toggleToast, toggleToastText, updateUserInfo } from '../store/actions/index.js';
...
const DesktopRightBarMultipleQuote = (props) => {
...
export default DesktopRightBarMultipleQuote;
